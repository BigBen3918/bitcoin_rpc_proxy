...
declare interface AddUserRequestType {
	username: 	string
	email:    	string
	webhook:    string
}
declare interface GetChainParamRequestType {
	chain:    	string
}

declare interface SetblockheightRequestType {
	chain:    		string
	position?:  	number
}

declare interface AddAddressRequestType {
	token: string
	data: Array<{
		chain: string
		address: string
